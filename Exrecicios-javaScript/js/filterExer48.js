...
// Segunda forma ......
const getStrongPokemonNames2 = (pokemons) =>
  pokemons.filter(({ level }) => level > 50).map(({ name }) => name);

console.log(getStrongPokemonNames2(pokemons));

/*
  Exercício 22: Usando o sort
  Utilize o método sort para ordenar o array de Pokémons em ordem crescente com base no nível de cada Pokémon.
*/

console.log(pokemons.sort((a, b) => a.level - b.level));
